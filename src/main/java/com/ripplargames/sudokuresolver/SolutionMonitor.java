...
public class SolutionMonitor<T> implements IMonitorSolution {
  ...
  private final long printIteration;
  @Getter
  private T accumulator;
  private long iteration;

  public SolutionMonitor(int boxLength, int gridLength, IntVar[][] grid, SolutionListener<T> listener, long printIteration) {
  ...
  public void onSolution() {
    ...
    if (printIteration > 0 && iteration >= printIteration) {
      System.out.println();
      System.out.println("=====");
